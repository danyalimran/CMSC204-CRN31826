...
public class MorseCodeConverterTestPublic {
	 ...
	 */
	@Test
	 public void testmorseCodeConverterConvertToEnglishCode() {
		
		String testConverter = MorseCodeConverter.convertToEnglish(". -.-. .-.. .. .--. ... . / .. -.. . / ..-. --- .-. / .--- .- ...- .-");
		assertEquals("eclipse ide for java", testConverter);
	}
	 ...
	 */
	@Test
	 public void testmorseCodeConverterConvertToEnglishFile() {
		
		File testFile = new File("src/howDoILoveThee.txt"); 
		try {
			assertEquals("how do i love thee let me count the ways", MorseCodeConverter.convertToEnglish(testFile));
		} catch (FileNotFoundException e) {
			assertTrue("An unwanted exception was caught", false);
		}
	}
