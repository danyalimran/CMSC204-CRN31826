...
//            	InputStreamReader newInputStreamReader = new InputStreamReader(clientSocket.getInputStream());
            	
            	// Listen for client to join, if so, accept
            	...
            	Reader readerForBufferedReader = new InputStreamReader(inputStream);
            	
            	 out = new PrintWriter(outputStream);
            	in = new BufferedReader(readerForBufferedReader);
